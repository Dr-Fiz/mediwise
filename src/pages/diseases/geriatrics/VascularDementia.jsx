...
const QUESTIONS = [
  {
    ...
    explanation_plabable: [
      "Vascular dementia often presents with a *stepwise* course, early executive dysfunction/processing speed issues, and focal neuro signs.",
      "Purely amnestic gradual decline favors Alzheimer’s; prominent visual hallucinations suggest Lewy body; early behavioural change favors FTD.",
    ],
    explanation_detail: [
      "Subcortical ischaemic changes (small-vessel disease) commonly drive dysexecutive syndrome with gait/urinary symptoms and pseudobulbar affect.",
    ],
  },
  {
    id: "VaD-2002",
    ...
    correct: "B",
    explanation_plabable: [
      "Vascular dementia is supported by small-vessel disease markers: WM hyperintensities, lacunar infarcts, strategic infarcts, microbleeds.",
      "Medial temporal atrophy favors Alzheimer’s; occipital pattern suggests Lewy body; anterior temporal/frontal suggests FTD.",
    ],
    explanation_detail: [
      "MRI is preferred over CT to assess WMH (Fazekas score), lacunes, and microbleeds; CT can show infarcts but is less sensitive for WM disease.",
    ],
  },
  {
    id: "VaD-2003",
    ...
    options: [
      ...
      {
        key: "C",
        text: "Oral anticoagulation (e.g., DOAC) unless contraindicated",
      }, // correct
    ...
    correct: "C",
    explanation_plabable: [
      "With AF and high CHA₂DS₂-VASc, oral anticoagulation reduces embolic stroke risk and is indicated unless contraindicated.",
      "Dual antiplatelet is not standard long-term for AF stroke prevention.",
    ],
    explanation_detail: [
      "Individualise bleeding risk and consider falls/PK interactions; involve patient/carers in shared decisions.",
    ],
  },
  {
    id: "VaD-2004",
    topic: "Geriatrics • Vascular dementia",
    difficulty: "Medium",
    vignetteTitle: "Cognitive therapy",
    stem:
      "A 72-year-old woman with MRI-proven small-vessel disease and cognitive impairment has mixed features suggesting Alzheimer’s and vascular pathology. " +
      "Which SINGLE pharmacologic approach is most reasonable to trial for symptomatic cognitive benefit?",
    options: [
      { key: "A", text: "High-dose haloperidol nightly" },
      {
        key: "B",
        text: "Cholinesterase inhibitor (e.g., donepezil) after stroke prevention is addressed",
      }, // correct
      {
        key: "C",
        text: "No treatment—drugs are ineffective in any vascular involvement",
      },
      { key: "D", text: "High-dose vitamin E" },
      { key: "E", text: "Topiramate off-label for cognition" },
    ],
    correct: "B",
    explanation_plabable: [
      "In *mixed* Alzheimer’s/vascular cases, a trial of cholinesterase inhibitor or memantine may help; evidence for pure VaD is limited.",
      "Always optimise vascular risk factors and secondary prevention in parallel.",
    ],
    explanation_detail: [
      "Non-pharmacologic measures (exercise, cognitive stimulation, routines, OT/PT) remain foundational.",
    ],
  },
];
