...
const QUESTIONS = [
  {
    id: "UI-2001",
    topic: "Geriatrics • Urinary Incontinence",
    difficulty: "Easy",
    vignetteTitle: "Classifying the type",
    stem: "An 80-year-old woman reports leakage when she **coughs, laughs, or lifts** shopping bags. No dysuria; voids every 3–4 hours. Which SINGLE type best fits?",
    options: [
    ...
    correct: "B",
    explanation_detail: [
      "**Stress incontinence** = leakage with ↑ intra-abdominal pressure (cough/sneeze/exertion) due to **urethral hypermobility** or **intrinsic sphincter deficiency**.",
  ...
  },
  {
    ...
    options: [
      ...
      { key: "B", text: "PVR ≥ 200–300 mL supports overflow/retention" }, // correct
    ...
    correct: "B",
    explanation_detail: [
      "[yellow]Rule of thumb[/yellow]: **PVR < 50 mL** normal; **50–199 mL** indeterminate; **≥200–300 mL** suggests **overflow/retention**.",
  ...
  },
  {
    ...
    correct: "C",
    explanation_detail: [
      "**Mirabegron** (β3-agonist) avoids anticholinergic adverse effects (**dry mouth**, **constipation**, **cognitive effects**, **angle-closure glaucoma** risk). Monitor **BP**.",
...
function LabValues() {
  const labs = [
    ...
    {
      name: "PVR (scan)",
      value: "<50 normal; 50–199 indeterminate; ≥200–300 overflow/retention",
    },
  ];
  return (
